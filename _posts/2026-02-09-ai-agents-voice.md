...
2. 🐍 [The Python Behind the Voice]({% post_url 2026-02-27-ai-agents-voice-python %}) — Azure VoiceLive SDK implementation deep-dive
3. ☁️ [Voice AI from Localhost to Cloud]({% post_url 2026-03-08-ai-agents-local-to-cloud %}) — deployment architecture
